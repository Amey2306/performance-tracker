...
export const WandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 11c.833.25 1.5.75 2.083 1.5.583.75.917 1.583.917 2.5 0 .917-.333 1.75-.917 2.5-.583.75-1.25 1.25-2.083 1.5m0 0a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zm0 0V3m0 0L9 5m3-2l3 2M3 15l2-2m14 2l-2-2m-9 9l2-2m6 2l-2-2" />
    </svg>
);
